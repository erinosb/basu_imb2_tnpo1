...
inputDir="/Users/ambikabasu/Nishimura_lab/Macros/231206_imaging_U2OS";
// note - this directory must exist already and contain .dv files 
outputDir="/Users/ambikabasu/Nishimura_lab/Macros/231206_imaging_U2OS/output";
...
for (i=0; i<dv_array.length; i++) {
	...
	// z project
	run("Z Project...", "start=10 stop=15 projection=[Max Intensity]");
...
// =====================================================================
  ...
  function makeReadme(folderPath) {
      ...
      content = content + "\n";
      content = content + "Project:  Ambika TNPO-1 vs GAPDH quant \n"; // Change this to project title
      content = content + "\n";
      ...
      content = content + "\n";
      content = content + "C1 = tnpo-1mRNA <- cy5 # Not used \n";
      content = content + "C2 = gapdhmRNA <- mCherry-Magenta \n";
